...
<div class="signup-form">
    <form method="post" action="home.php">
        ...
        <div class="form-group">
			<label class="checkbox-inline"><input type="checkbox" required="required" name="terms"> Eu aceito os <a href="#">termos de uso</a> &amp; a <a href="#">política de privadade</a> deste site.</label> 
		</div>
		<div class="form-group">
